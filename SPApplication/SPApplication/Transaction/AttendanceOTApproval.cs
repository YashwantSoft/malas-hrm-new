...
{
    public partial class AttendanceOTApproval : Form
    {
            ...
            if (!ValidationMain())
            {
                for (int i = 0; i < dataGridView1.Rows.Count; i++)
                {
                    ...
                    if (isChecked)
                    {
                        ...
                        objBL.Query = "update attendancelogs set ApprovalStatusId="+ cmbApprovalStatus.SelectedValue+ ",ManagerRemarks='" + txtRemarks.Text + "' where AttendanceLogId=" + AttendanceLogId + "";
                        ...
                        //objBL.Query = "update attendancerecordmaster set ApprovalStatusId=" + cmbApprovalStatus.SelectedValue + ",CompleteFlag=" + CompleteFlag + ", OTApprovalFlag=" + OTApprovalFlag + " where AttendanceDate='" + dtpAttenanceDate.Value.ToString(BusinessResources.DATEFORMATYYYYYMMDD) + "' and LocationId=" + cmbLocation.SelectedValue + " and DepartmentId=" + cmbDepartment.SelectedValue + "";
                        //Result = objBL.Function_ExecuteNonQuery();
        ...
        private void cbTransferOut_CheckedChanged(object sender, EventArgs e)
        {

        }

        private void cbTransferIn_CheckedChanged(object sender, EventArgs e)
        {
        ...
        private void cmbAttendanceStatus_SelectionChangeCommitted(object sender, EventArgs e)
        {
            ...
            {
                if (cmbApprovalStatus.Text == "Remarks")
                {
        ...
        private void FillGrid()
        {
            ...
            WhereClause += " and AL.ApprovalStatusId IN (2,3,6,8) ";
        ...
        private void AttendanceOTApproval_Load(object sender, EventArgs e)
        {
