...
{
    public partial class EmployeeTypeMaster : Form
    {
        ...
        private void Employee_Type_Master_Load(object sender, EventArgs e)
        {
            ClearAll();
            FillGrid();
        }
            ...
            if (objPC.ViewFlag == 1)
            {
                try
                {
                    ...
                    if (RowCount_Grid >= 0 && CurrentRowIndex >= 0)
                    {
                        ...
                        txtEmployeeType.Text = dataGridView1.Rows[e.RowIndex].Cells[1].Value.ToString();
        ...
        protected bool CheckExist()
        {
            ...
            ds = objQL.SP_EmployementTypeMaster_CheckExist();
        ...
        protected void SaveDB()
        {
            if (!Validation())
            {
                objPC.EmployementTypeId = TableId;
                objPC.EmployementType = txtEmployeeType.Text;
                ...
                Result = objQL.SP_EmployementTypeMaster_Insert_Update_Delete();
                if (Result > 0)
                {
                    if (!FlagDelete)
        ...
        protected void FillGrid()
        {
            ...
            DataSet ds = new DataSet();
            objPC.EmployementType = txtSearch.Text;
            ...
            ds = objQL.SP_EmployementTypeMaster_FillGrid();
            ...
            if (ds.Tables[0].Rows.Count > 0)
            {
                ...
                //0 EmployeeTypeId,
                //1 EmployeeType as 'Employee Type',  
                //2 Description, 
